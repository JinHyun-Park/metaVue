            ...
            <table id="list" class="table table-striped table-bordered table-hover">
                ...
                <tbody id="contacts">
                    <tr v-for="contact in contactlist.contacts" :key="contact.no">
                        ...
                        <td><button class="btn btn-primary" @click="editContact(contact.no)">편집</button>
...
<style scoped>
    ...
    img.thumbnail {width:48px; height: 48; margin-top: auto; margin-bottom: auto; display: block; cursor:pointer;}
</style>