        ...
        <div class="form" @keyup.esc="cancelEvent">
            <form method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label>
                        <input ref="photofile" type="file" name="photo" class="long btn-default" />
                    </label>
                </div>
                <div>
                    <div>&nbsp;</div>
...
<style scoped>
    .modal1 {z-index:10; display: block; position: fixed; z-index: 1; left: 0; top:0; width: 100%;
    ...
    .form {z-index: 10; background-color: white; margin: 100px auto;
        max-width: 400px; min-width: 200px; padding: 10px 10px 10px 10px; font:13px "vernada";}
